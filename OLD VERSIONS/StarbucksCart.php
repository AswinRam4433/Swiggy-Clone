                        ...
                        if($result){
                                ...
                                // output data of each row
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<input type="submit" value="Add To Cart" name="Add"><br>';
                                            echo'</form>';
                                            ...
                                            if(isset($_POST["cart"])){
                                                    ...
                                                    // $adesc=$row["DESCR"];
                                                    // $aname=$row["DISHNAME"];
                                                    // // $aqty="qty".'$_POST[$aname]';
                                                    // // $aformqty=$_POST[$adishqty];
                                                    
                                                    // $apic=$row["PIC"];
                                                    // $aprice=$row["PRICE"];
                                                    // // $addsql="INSERT INTO cart(DESCR, DISHNAME, PRICE, PIC,QUANTITY) VALUES ('$adesc','$aname','$aprice','$apic','$adishqty') WHERE '$aformqty'>0" ;
                                                    // $addsql="INSERT INTO cart(DESCR, DISHNAME, PRICE, PIC,QUANTITY) VALUES ('$adesc','$aname','$aprice','$apic','$adishqty')" ;
                                                    // $conn->query($addsql);
