...
<head>
    ...
    <title>Parvati Bhawan Sweets</title>
...
<body>
    ...
    <div id="header">
        ...
        <div><img src="ParvatiBhawan.jpg" alt="Parvati Bhawan" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Parvati Bhawan</h2>
              ...
              <div class="menu">
                <!-- Adding PHP to retrieve MySQL -->
                    <?php
                        ...
                        if($result){
                                // echo "First IF block satisifed";
                                // if (mysqli_num_rows($result) > 0) 
                                if(1<100){
                                // output data of each row
                                        // echo"Second IF Block satisifed";
                                        while($row = mysqli_fetch_assoc($result)) {
                                            // echo "DESCR: " . $row["DESCR"]. " - Name: " . $row["DISHNAME"]. " " . $row["PRICE"]. "<br>";
