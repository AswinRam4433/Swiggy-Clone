<!DOCTYPE html>
<!--SANDBOX THAT WORKS WHEN I CONVERT IT TO .PHP FILE -->
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="LoginPageCSS.css" media="all" type="text/css">
      ...
      <form class="login__form" id="loginForm">
        ...
        <?php
                        ...
                        if (!$conn) {
                            ...
                            $sql = "select *from users where UNAME = '$enteredusername' and password = '$enteredpassword'";  
