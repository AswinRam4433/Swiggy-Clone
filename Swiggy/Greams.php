...
<head>
    ...
    <title>Fruit Shop On Greams Road</title>
...
<body>
    ...
    <div id="header">
        ...
        <div><img src="greamsfruit.jpg" alt="Greams Road" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Fruit Shop on Greams Road</h2>
            <span>Beverages,Snacks,Cakes</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM greams";
