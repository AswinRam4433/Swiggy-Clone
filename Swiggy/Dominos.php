...
<body>
    ...
    <div id="header">
        ...
        <div><img src="dominos.jpg" alt="Dominos Pizza" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Domino's Pizza</h2>
            <span>Pizzas,Fast Food</span>
            <br>
            <span class="cost">&#8377;550</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM dominos";
