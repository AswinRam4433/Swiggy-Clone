...
<body>
    ...
    <div id="header">
        ...
        <div><img src="ssbiryani.jpg" alt="SS Biryani" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>SS Biryani</h2>
            <span>Biryani,Tandoori</span>
            <br>
            <span class="cost">&#8377;1100</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM ssbiryani";
