...
<body>
    ...
    <div id="header">
        ...
        <div><img src="redbox.jpg" alt="Redbox" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Redbox</h2>
            <span>Authentic Chinese,Fusion</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM redbox";
