...
<head>
    ...
    <link rel="icon" href="SwiggyLogo.png" >
...
<body>
    ...
    <div id="header">
        ...
        <div><img src="anjappar.jpg" alt="Anjappar" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Anjappar</h2>
            <span>Chettinad,Chinese,Grills</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM anjappar";
