...
<body>
    ...
    <div id="header">
        ...
        <div><img src="ibaco.jpg" alt="Ibaco Ice Creams" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Ibaco Ice Creams</h2>
            <span>Cakes,Ice-Creams</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM ibaco";
