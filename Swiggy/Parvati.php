...
<head>
    ...
    <script>
        function SwiggyLogoTopNavClick(){
        window.open("Working Page.html#LassiHotel","_blank");
        }
        function OffersTopNavClick(){
            window.open("Working Page.html","_blank");
        }
        function CartTopNavClick(){
            window.open("http://localhost/aswinPrograms/Swiggy/Cart.php","_self");
        }
    </script>
</head>
<body>
    ...
    <div class="topnav" id="myTopnav" onclick="clicked()">
        <a onclick="SwiggyLogoTopNavClick()"><img src="SwiggyLogo.png" class="swiggylogoleft"></a>
        
        <a onclick="OffersTopNavClick()">Offers</a>
        
        <a onclick="CartTopNavClick()">Cart</a>
    
    </div>
    <div id="header">
        
        <div><img src="ParvatiBhawan.jpg" alt="Parvati Bhawan Image" id="headerImage"></div>
        <div class="hotelOverview">
            <h2>Parvati Bhawan Sweets</h2>
            <span>Sweets,Snacks,Chats,Juices</span>
            <br>
              ...
              <div class="menu">
                ...
                <nav class="hotel-list">
                    ...
                    <?php
                        ...
                        $sql = "SELECT DESCR, DISHNAME, PRICE, VEG, PIC, REMARKS FROM parvati";
